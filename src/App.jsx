  ...
  return (
    <div className="App">
      ...
      <nav className="navbar">
        <h1 className="logo" onClick={() => setView('HOME')}>Ink & Ease</h1>
        <div className="nav-links">
          <span onClick={() => setView('HOME')}>Studio</span>
          <span onClick={() => setView('HOME')}>Artists</span>
          <span onClick={() => alert('Contact: 123 Botanical Way | hello@inkandease.com')}>Connect</span>
        </div>
      </nav>
